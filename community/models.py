...
class Community(models.Model):
    handle = models.SlugField(
        ...
        help_text=pgettext_lazy("community__handle__help", "Once you set this, it cannot be changed. Pick carefully as this will be the identifier to find your community leaderboard."),
    )
