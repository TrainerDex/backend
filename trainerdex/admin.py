...
class UpdateAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ['submission_date', 'last_modified', 'pokedex_gen6', 'pokedex_gen7', 'pokedex_gen8']
    fieldsets = [
        (None, {'fields': ['trainer', 'update_time', 'submission_date', 'last_modified', 'gymbadges_total', 'gymbadges_gold', 'stardust']}),
        (_('Basic Info'), {'fields': ['travel_km', 'capture_total', 'pokestops_visited', 'total_xp']}),
        (_('Medals'), {'fields': ['evolved_total', 'hatched_total', 'big_magikarp', 'battle_attack_won', 'battle_training_won', 'small_rattata', 'pikachu', 'unown', 'raid_battle_won', 'legendary_battle_won', 'berries_fed', 'hours_defended', 'challenge_quests', 'max_level_friends', 'trading', 'trading_distance', 'great_league', 'ultra_league', 'master_league', 'photobomb', 'pokemon_purified', 'rocket_grunts_defeated', 'buddy_best', 'wayfarer']}),
        (_('Type Medals'), {'fields': ['type_normal', 'type_fighting', 'type_flying', 'type_poison', 'type_ground', 'type_rock', 'type_bug', 'type_ghost', 'type_steel', 'type_fire', 'type_water', 'type_grass', 'type_electric', 'type_psychic', 'type_ice', 'type_dragon', 'type_dark', 'type_fairy']}),
        (_('Pokédex'), {'fields': ['pokedex_total_caught', 'pokedex_total_seen', 'pokedex_gen1', 'pokedex_gen2', 'pokedex_gen3', 'pokedex_gen4', 'pokedex_gen5', 'pokedex_gen6', 'pokedex_gen7', 'pokedex_gen8']}),
    ]
...
class TrainerAdmin(UserAdmin):
    ...
    fieldsets = [
        ...
        (_('Permissions'), {'fields': ['is_active', 'is_banned', 'is_verified', 'is_staff', 'is_superuser', 'groups', 'user_permissions']}),
